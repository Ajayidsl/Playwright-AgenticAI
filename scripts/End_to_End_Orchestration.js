...
const OUTPUTS = {
  appIntelligence: path.join(AI_DIR, "app_intelligence_admin.json"),
...
const STAGES = {
  appIntelligence: {
    ...
    output: OUTPUTS.appIntelligence,
    prompt:
      "@Application Intelligence Agent explore the admin application safely, capture raw UI intelligence and derived analysis together, and store the unified result in ai_knowledge/ai_Knowledge_Admin/app_intelligence_admin.json",
  },
  testcases: {
    name: "Test Case Generator Agent",
    output: OUTPUTS.testcases,
    prompt:
      "@Test Case Generator Agent read ai_knowledge/ai_Knowledge_Admin/app_intelligence_admin.json and generate comprehensive structured QA test cases with maximum practical coverage in ai_knowledge/ai_Knowledge_Admin/testcases_admin.json",
  },
  codegen: {
    name: "Playwright Code Generator",
    output: OUTPUTS.generatedSpecs,
    prompt:
      "@Playwright Code Generator read ai_knowledge/ai_Knowledge_Admin/testcases_admin.json, generate Playwright specs for the available structured QA test cases using the existing Page Objects and pageObjectManager.spec.js framework, store specs under tests/generated/admin, and save ai_knowledge/ai_Knowledge_Admin/generated_specs_admin.json",
  },
  execute: {
...
async function runFullFlow() {
  ...
  await runStage(STAGES.appIntelligence);
